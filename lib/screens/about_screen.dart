  ...
  static const _helpSections = <(String, String)>[
    (
      ...
      '• برای به‌روزرسانی آب‌وهوا، صفحه را از بالا به پایین بکشید.\n'
          '• می‌توانید شهرهای ایران را مستقیماً از داخل برنامه انتخاب کنید یا با کمک هوش مصنوعی و Google موقعیت جغرافیایی هر نقطه را بدست آورده و وارد برنامه کنید تا آب‌وهوای آنجا را همیشه در اختیار داشته باشید.\n'
    ...
    (
      ...
      '• در بخش افزودن مناسبت، تاریخ و سپس عنوان مناسبت خود را وارد کنید.\n'
          ...
          '• گوشی را به‌صورت افقی بگیرید تا بتوانید دقیق از قطب‌نما استفاده کنید، ضمن اینکه طول و عرض جغرافیایی مکان خود را نیز از دکمه پایین می‌توانید بدست آورید.',
    ),
    (
      '💊 یادآوری',
