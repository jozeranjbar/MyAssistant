    ...
    final features = <(String, String)>[
      (
        ...
        'تا ۴ نقطه انتخابی با دما، احساس دما، رطوبت، باد، UV و پیش‌بینی ۱۰ روزه. '
            'هم می‌توان از داخل برنامه، هر شهری را انتخاب کرد و هم می‌توان با نگه داشتن چند ثانیه انگشت خود روی هر نقطه از نقشه گوگل مپ، '
            'طول و عرض جغرافیایی آن نقطه را به دست آورد (عدد اول کوچک‌تر از ۹۰ و عدد دوم کوچک‌تر از ۱۸۰ است). '
            'آن‌ها را با سه رقم اعشارشان، وارد برنامه می‌کنیم تا همیشه آب‌وهوای ده‌روزه‌ی آنجا را در گوشی داشته باشیم.',
      ),
      (
        '🗓️ تقویم کامل',
